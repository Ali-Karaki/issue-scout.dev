      ...
      {!compact && (
        <div className="flex flex-wrap items-center justify-between gap-2 mt-3">
          ...
          <a
            ...
            className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0 p-1.5 rounded-lg bg-amber-600 hover:bg-amber-500 text-zinc-900 no-underline focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-bg"
          >
